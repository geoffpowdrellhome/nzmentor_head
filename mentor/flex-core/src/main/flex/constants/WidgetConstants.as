...
public class WidgetConstants {
    ...
    public static function getPaxSelectableStaticDataSpark():ArrayList {
        var paxStaticList:ArrayList = new ArrayList();

        paxStaticList.addItem(new IdValuePair(0, '0'));
        paxStaticList.addItem(new IdValuePair(1, '1'));
        paxStaticList.addItem(new IdValuePair(2, '2'));
        paxStaticList.addItem(new IdValuePair(3, '3'));
        paxStaticList.addItem(new IdValuePair(4, '4'));
        paxStaticList.addItem(new IdValuePair(5, '5'));
        paxStaticList.addItem(new IdValuePair(6, '6'));
        paxStaticList.addItem(new IdValuePair(7, '7'));
        paxStaticList.addItem(new IdValuePair(8, '8'));
        paxStaticList.addItem(new IdValuePair(9, '9'));
        paxStaticList.addItem(new IdValuePair(10, '10'));
        paxStaticList.addItem(new IdValuePair(11, '11'));
        paxStaticList.addItem(new IdValuePair(12, '12'));
        paxStaticList.addItem(new IdValuePair(13, '13'));
        paxStaticList.addItem(new IdValuePair(14, '14'));
        paxStaticList.addItem(new IdValuePair(15, '15'));
        paxStaticList.addItem(new IdValuePair(16, '16'));
        paxStaticList.addItem(new IdValuePair(17, '17'));
        paxStaticList.addItem(new IdValuePair(18, '18'));
        paxStaticList.addItem(new IdValuePair(19, '19'));
        paxStaticList.addItem(new IdValuePair(20, '20'));

        return paxStaticList;
    }
